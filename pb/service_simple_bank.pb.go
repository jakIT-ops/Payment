...
import (
	...
	pb "https://github.com/jakIT-ops/Payment/pb"
	reflect "reflect"
)
...
var file_service_simple_bank_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12,
	...
	0x69, 0x66, 0x79, 0x5f, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x42, 0x11, 0x5a, 0x0f, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x66, 0x75, 0x6c, 0x6c, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var file_service_simple_bank_proto_goTypes = []interface{}{
	(*pb.CreateUserRequest)(nil),   // 0: pb.CreateUserRequest
	(*pb.UpdateUserRequest)(nil),   // 1: pb.UpdateUserRequest
	(*pb.LoginUserRequest)(nil),    // 2: pb.LoginUserRequest
	(*pb.VerifyEmailRequest)(nil),  // 3: pb.VerifyEmailRequest
	(*pb.CreateUserResponse)(nil),  // 4: pb.CreateUserResponse
	(*pb.UpdateUserResponse)(nil),  // 5: pb.UpdateUserResponse
	(*pb.LoginUserResponse)(nil),   // 6: pb.LoginUserResponse
